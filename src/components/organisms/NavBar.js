...
const Navbar = ({fontColor}) => {
    return (
        ...
        <Link to="/"  className=" ml-[15px] text-[#A46A7E] font-merriweather text-[20px]" >Home</Link>
        ...
        <Link to="/obsess"  className=" ml-[15px] text-[#A46A7E] font-merriweather text-[20px]">Obsess</Link>
