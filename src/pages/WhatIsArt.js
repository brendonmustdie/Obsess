...
function WhatIsArt() {
    ...
    <p>In transitioning to film, playwrights and directors, lost the benefits of having a life audience - but they gained newfound power in changing how the audience experiences their work. This is similar to the way artists transition to the internet - we lose some aspects, but we gain accessability and new control in how our works are viewed and interacted with. </p>
     ...
     <p>Danae’s "Net Art, Post-internet Art, New Aesthetics: The Fundamentals of Art on the Internet” (2019) seeks to provide discussions and frameworks the define different kinds of art on the internet. </p>
     <p>
     ...
     <p>Net Art, Danae explains, relates to “network art”, which started being explored in the 1970s, when Videotex (the end-user information system) became widely used. (Danae, 2019)</p>
     <p>We refer to net art are when talking about art produced during the “Web 1.0” era, in the 90’s - this time is concerned with static web pages without user interface. (Danae, 2019)</p>
     ...
     <p>New Aesthetics, a phrase that was used in 2012, refers to “the merging of the virtual and the physical” which occurs because of the internet and digital technology. (Danae, 2019)</p>
     <p>“New Aesthetics reviews the network itself” - it’s function and structure, as they become important to the arts. (Danae, 2019)</p>
     <p>Danae’s work is very interesting but has always felt just out of my grasp, I’ve read this paper a few times and even written a couple of summaries for myself and it’s overall meaning still seems to evade me. The definitions of different internet artwork categories are not quite yet agreed upon and that makes this even harder to get through. </p>
     <h2 className='font-semibold text-[30px]'>References:</h2>
     <p>Carrier, D (2020) 'The work of art in the age of the internet'</p>
     <p>DANAE (2019) ‘Net Art, Post-internet Art, New Aesthetics: The Fundamentals of Art on the Internet’, DIGITAL ART WEEKLY | Medium, 31 January.</p>
    <p>Benjamin, W. (1936),'The Work of Art in the Age of
