  ...
  return (
   ...
   <Navbar fontColor="black"/>
     <div className=" bg-cover bg-no-repeat bg-[url(./images/candy-hearts.jpg)] p-[100px]">
      ...
      <h1 className='text-[60px] font-blackHan text-white'>What is Cognotive behavioral Therapy (CBT)?</h1>
      <p className='text-[10px] font-blackHan text-white'>By Kendra Cherry, reviewed by Rachel Goldman, PhD, FTOS</p>
      </div>
    </div>
   ...
   <h2 className='font-semibold text-[30px]'>What is CBT?</h2>
      ...
      <ul>
        ...
        <li>Multimodal therapy suggests that psychological issues must be treated by addressing seven different but interconnected modalities: behavior, affect, sensation, imagery, cognition, interpersonal factors, and drug/biological considerations.</li>
    ...
    <ol className='justify-items-start'>
      ...
      <li>Generate a list of potential solutions</li>
      <li>Evaluate the strengths and weaknesses of each potential solution</li>
      <li>Choose a solution to implement</li>
    ...
    <ul className='justify-items-start'>
      ...
      <li>It is an effective short-term treatment option as improvements can often be seen in five to 20 sessions.</li>
      <li>It is effective for a wide variety of maladaptive behaviors.</li>
      <li>It is often more affordable than some other types of therapy.</li>
      <li>It is effective whether therapy occurs online or face-to-face.</li>
...
<li>Cognitive behavioral therapy has been scientifically proven to be effective in treating symptoms of depression and anxiety in children and adolescents.</li>
<li>A 2018 meta-analysis of 41 studies found that CBT helped improve symptoms in people with anxiety and anxiety-related disorders, including obsessive-compulsive disorder and post-traumatic stress disorder.</li>
...
<ul className='justify-items-start'>
  ...
  <li>Contact your health insurance to see if it covers cognitive behavioral therapy and, if so, how many sessions are covered per year.</li>
  <li>Make an appointment with the therapist you've chosen, noting it on your calendar so you don't forget it or accidentally schedule something else during that time.</li>
  <li>Show up to your first session with an open mind and positive attitude. Be ready to begin to identify the thoughts and behaviors that may be holding you back, and commit to learning the strategies that can propel you forward instead.</li>
</ul>
