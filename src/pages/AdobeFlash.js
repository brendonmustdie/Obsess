...
function AdobeFlash() {
  return (
    ...
    <p>McNamara, R. (2020) ‘RIP Adobe Flash: Five Takeaways About the Plug-in’s Legacy in Net Art’, Hyperallergic, 18 December.</p>
    </div>
